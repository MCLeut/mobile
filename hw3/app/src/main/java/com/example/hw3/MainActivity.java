...
public class MainActivity extends Activity implements OnClickListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        btn0 = (Button) btn0.findViewById(R.id.button0);
        btn1 = (Button) btn1.findViewById(R.id.button1);
        btn2 = (Button) btn2.findViewById(R.id.button2);
        btn3 = (Button) btn3.findViewById(R.id.button3);
        btn4 = (Button) btn4.findViewById(R.id.button4);
        btn5 = (Button) btn5.findViewById(R.id.button5);
        btn6 = (Button) btn6.findViewById(R.id.button6);
        btn7 = (Button) btn7.findViewById(R.id.button6);
        btn8 = (Button) btn8.findViewById(R.id.button7);
        btn9 = (Button) btn9.findViewById(R.id.button8);
